...
class KnowledgeQueryApp {
    constructor(config = {}) {
        ...
        this.templateAgentType = 'VERIFICATION';  // テンプレートAPI用
    ...
    onTemplateSelected() {
        const select = document.getElementById('promptTemplateSelect');
        if (!select) return;
        // Just update selection, don't auto-insert
    ...
    insertSelectedTemplate() {
        ...
        if (currentValue) {
            // Append template below existing text
    ...
    resetChatSession() {
        ...
        sessionStorage.removeItem('verificationPlanSessionId');
        ...
        this.chatSessionId = 'verification_' + generateUUID();
        sessionStorage.setItem('verificationPlanSessionId', this.chatSessionId);
